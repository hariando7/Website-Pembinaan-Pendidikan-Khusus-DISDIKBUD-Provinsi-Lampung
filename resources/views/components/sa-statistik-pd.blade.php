<!-- Main modal -->
<div id="select-modal1" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative bg-[#297785] rounded-lg shadow">
            ...
            <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t">
                <h3 class="text-lg font-bold text-white">
                    Statistik Peserta Didik SLB Provinsi Lampung
                </h3>
                <button type="button"
                    ...
                    data-modal-toggle="select-modal1">
            ...
            <div class="p-4 md:p-5">
                ...
                <ul class="space-y-4 mb-4">
                    <li>
                        <a href="/sa-statistik-pd-sekolah" for="job-1"
                            ...
                            <div class="block">
                                <div class="w-full text-lg font-semibold text-white">Statistik Sekolah</div>
                            </div>
                    ...
                    <li>
                        <a href="/sa-statistik-pd-kelas" for="job-1"
                            class="inline-flex items-center justify-between w-full p-5 text-white border border-[#FA8F21] rounded-lg cursor-pointer peer-checked:border-blue-600 peer-checked:text-white hover:text-white bg-[#FA8F21] hover:bg-[#D87815]">
                            <div class="block">
                                <div class="w-full text-lg font-semibold text-white">Statistik Kelas</div>
                            </div>
                            <svg class="w-4 h-4 ms-3 rtl:rotate-180 text-white" aria-hidden="true"
                                xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <li>
                        <a href="/sa-statistik-pd-jenisKetunaan" for="job-1"
                            class="inline-flex items-center justify-between w-full p-5 text-white border border-[#FA8F21] rounded-lg cursor-pointer peer-checked:border-blue-600 peer-checked:text-white hover:text-white bg-[#FA8F21] hover:bg-[#D87815]">
                            <div class="block">
                                <div class="w-full text-lg font-semibold text-white">Statistik Jenis Ketunaan</div>
                            </div>
                            <svg class="w-4 h-4 ms-3 rtl:rotate-180 text-white" aria-hidden="true"
                                xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <li>
                        <a href="/sa-statistik-pd-tahun" for="job-1"
                            class="inline-flex items-center justify-between w-full p-5 text-white border border-[#FA8F21] rounded-lg cursor-pointer peer-checked:border-blue-600 peer-checked:text-white hover:text-white bg-[#FA8F21] hover:bg-[#D87815]">
                            <div class="block">
