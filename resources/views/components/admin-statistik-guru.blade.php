<!-- Modal toggle -->
<button data-modal-target="select-modal" data-modal-toggle="select-modal" title="Visualisasi Statistik Guru SLB Berdasarkan PNS, Sertifikasi dan Tahun Ajaran"
        ...
        <div class="relative bg-[#297785] rounded-lg shadow">
            ...
            <div class="p-4 md:p-5">
                ...
                <ul class="space-y-4 mb-4">
                    <li>
                        <a href="/admin-statistik-guru-pns" for="job-1"
                    ...
                    <li>
                        <a href="/admin-statistik-guru-sertifikasi" for="job-1"
                            class="inline-flex items-center justify-between w-full p-5 text-white border border-[#FA8F21] rounded-lg cursor-pointer peer-checked:border-blue-600 peer-checked:text-white hover:text-white bg-[#FA8F21] hover:bg-[#D87815]">
                            <div class="block">
                    ...
                    <li>
                        <a href="/admin-statistik-guru-tahun" for="job-1"
                            class="inline-flex items-center justify-between w-full p-5 text-white border border-[#FA8F21] rounded-lg cursor-pointer peer-checked:border-blue-600 peer-checked:text-white hover:text-white bg-[#FA8F21] hover:bg-[#D87815]">
                            <div class="block">
