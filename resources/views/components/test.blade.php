    ...
    <aside id="default-sidebar"
        class="fixed top-0 left-0 z-20 w-64 h-full transition-transform -translate-x-full sm:translate-x-0"aria-label="Sidebar">
        <div class="h-full px-4 py-4 bg-[#297785]">
            <a href="/admin-home-slb">
                <img src="/assets/landing/prov-lampung2.svg" alt=""
                    class="w-[40%] h-[40%] m-auto items-center lg:w-[80px] lg:h-[100px]">
            </a>
            <div class="flex items-center justify-center m-auto text-white">
                <ul class=''>
                    <div class="overflow-y-auto max-h-100 important">
                        {{-- peserta didik slb --}}
                        @php
                            $activePagePath = [
                        ...
                        @endphp
                        <li class="flex items-center justify-center w-full -inset-x-0 mt-3">
  ...
  @if (in_array(Request::path(), $activePagePath)) rounded-lg bg-white text-[#297785] focus:z-10 focus:ring-2 focus:ring-white focus:text-white
                                    ...
                                    <svg width="28" height="28" viewBox="0 0 28 28" fill="none"
                                        ...
                                        <g clip-path="url(#clip0_440_17755)">
                                            ...
                                            <path
                                                ...
                                                fill="currentColor" stroke="currentColor" />
                                            <path d="M6.22217 6.22217H7.77772V7.77772H6.22217V6.22217Z"
                                                fill="currentColor" stroke="currentColor" />
                                            <path d="M9.3335 6.22217H10.8891V7.77772H9.3335V6.22217Z"
                                                fill="currentColor" stroke="currentColor" />
                                            <path d="M12.4443 6.22217H13.9999V7.77772H12.4443V6.22217Z"
                                                fill="currentColor" stroke="currentColor" />
                                            <path d="M6.22217 10.1113H7.77772V11.6669H6.22217V10.1113Z"
                                                fill="currentColor" stroke="currentColor" />
                                            <path d="M9.3335 10.1113H10.8891V11.6669H9.3335V10.1113Z"
                                                fill="currentColor" stroke="currentColor" />
                                            <path d="M12.4443 10.1113H13.9999V11.6669H12.4443V10.1113Z"
                                                fill="currentColor" stroke="currentColor" />
                                            ...
                                            <path d="M12.4443 14H13.9999V15.5556H12.4443V14Z" fill="currentColor"
                                                stroke="currentColor" />
                                            <path d="M6.22217 17.8887H7.77772V19.4442H6.22217V17.8887Z"
                                                fill="currentColor" stroke="currentColor" />
                                            <path d="M9.3335 17.8887H10.8891V19.4442H9.3335V17.8887Z"
                                                fill="currentColor" stroke="currentColor" />
                                            <path d="M12.4443 17.8887H13.9999V19.4442H12.4443V17.8887Z"
                                                fill="currentColor" stroke="currentColor" />
                                            <path d="M17.8887 10.1113H19.4442V11.6669H17.8887V10.1113Z"
                                                fill="currentColor" stroke="currentColor" />
                                            ...
                                            <path d="M21 14H22.5556V15.5556H21V14Z" fill="currentColor"
                                                stroke="currentColor" />
                                            <path d="M17.8887 17.8887H19.4442V19.4442H17.8887V17.8887Z"
                                                fill="currentColor" stroke="currentColor" />
        ...
        @else
            text-white rounded-lg hover:bg-white hover:text-[#297785] focus:z-10 focus:ring-2 focus:ring-white focus:text-white @endif">
                    ...
                    <li class="w-full -inset-x-0 bottom-0">
                        <a type="button" id="logOut" href="/login"
                            class="gap-3 py-1 mb-5 flex items-center justify-center m-auto rounded-md bg-[#FF0000] hover:bg-[#D51717] text-white p-2 pt-2 pb-2">
                            Logout
                        </a>
                    </li>
                </ul>
