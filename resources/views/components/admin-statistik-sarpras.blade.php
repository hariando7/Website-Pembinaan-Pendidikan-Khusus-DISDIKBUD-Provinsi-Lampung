<!-- Modal toggle -->
<button data-modal-target="select-modal" data-modal-toggle="select-modal" title="Visualisasi Statistik Sarpras SLB Berdasarkan Tahun Ajaran"
        ...
        <div class="relative bg-[#297785] rounded-lg shadow">
            ...
            <div class="p-4 md:p-5">
                ...
                <ul class="space-y-4 mb-4">
                    <li>
                        <a href="/admin-statistik-sarpras-tahun" for="job-1"
