...
<head>
    ...
    <title>Admin | Edit Peserta Didik SLB</title>
...
<body class="bg-white z-10">
    <div>
        ...
        <div class="pl-[280px] h-screen pt-2 pr-5 pb-28">
            <div class="pb-2 mt-5">
                <div class="text-[#297785] font-bold text-[32px]">Edit Peserta Didik SLB - {{ $sekolah->nama }}
                </div>
                <div class="flex justify-between pb-2">
                    <div class="div">
                        <x-buttitle-landing ref="/admin-pesertadidik-slb" color="#FA8F21" width="[8rem]" title="kembali"
