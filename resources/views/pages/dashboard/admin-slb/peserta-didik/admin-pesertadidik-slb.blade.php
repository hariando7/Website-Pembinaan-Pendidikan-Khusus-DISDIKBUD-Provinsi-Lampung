...
<body class="bg-white z-10">
    <div>
        ...
        <div class="pl-[280px] h-screen pt-2 pr-5 pb-[85px] full-height">
            ...
            <div class="rounded shadow-lg h-full border-solid border-4 border-[#297785] p-5">
                <div class="max-h-[calc(100%-1rem)] overflow-y-auto">
                    {{-- isi konten disini --}}
                    <div class="flex justify-content-between gap-2">
                            ...
                            <form>
                                <div class="w-full">
                                    <button id="dropdown-button" data-dropdown-toggle="dropdown"
                                        class="w-full z-10 inline-flex items-center py-2.5 px-4 text-sm font-medium text-center text-[#297785] border-2 border-[#297785] dark:border-[#297785] focus:border-[#FA8F21] dark:text-[#297785] rounded-lg focus:ring-none"
                                    ...
                                    <div id="dropdown"
                                        ...
                                        <ul class="py-2 text-sm text-gray-700 dark:text-gray-200"
                                            ...
                                            <li>
                                                <a href="#"
                                                    class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">test1</a>
                                            </li>
                                            <li>
                                                <a href="#"
                                                    class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">test2</a>
                                            </li>
                                            <li>
                                                <a href="#"
                                                    class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">test3</a>
                                            </li>
                                            <li>
                                                <a href="#"
                                                    class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">test4</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="flex-1">
                            <form class="flex items-center max-w-sm mx-auto my-auto">
                                <div class="relative w-full">
                                    ...
                                    <input type="text" id="simple-search"
                                        class="border-2 border-[#297785] dark:border-[#297785] text-black text-sm rounded-lg focus:border-[#FA8F21] block w-full ps-10 p-2.5 dark:hover:text-black dark:placeholder-gray-400 dark:focus:ring-[#FA8F21]"
                                        placeholder="Search..." required />
                                </div>
                            </form>
                        </div>
                        <div class="flex-1 w-[20%] flex">
                            <button type="button"
                                class="text-white bg-white hover:bg-white border border-[#FA8F21] dark:border-[#FA8F21] focus:ring-4 focus:outline-none focus:ring-[#FA8F21] font-medium rounded-lg text-sm px-5 py-2 text-center inline-flex items-center dark:focus:ring-[#FA8F21] dark:bg-[#FA8F21] dark:text-white dark:hover:bg-[#D87815] w-full gap-2 text-center">
