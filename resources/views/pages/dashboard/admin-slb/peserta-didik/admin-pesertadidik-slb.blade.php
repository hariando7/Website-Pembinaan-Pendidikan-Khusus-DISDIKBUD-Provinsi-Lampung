...
<body class="z-10 bg-white">
                ...
                <div class="flex items-center justify-center rounded gap-2 h-20 border-dashed border-2 border-[#297785] rounded-lg"
                    ...
                    <div>
                        ...
                        <button data-modal-target="modal-admin-peserta-didik"
                            ...
                            type="button">
                            <x-svg-statistik />
                            <span class="hidden sm:inline">Statistik Peserta Didik</span>
                        </button>
                    ...
                    <div>
                        ...
                        <button data-modal-target="button-tambah" data-modal-toggle="button-tambah" type="button"
                            class="btn border-none text-white text-center py-2 lg:py-2 hover:bg-[#D87815 w-[4.5rem] lg:w-[14.5rem] py-1 my-2 flex items-center justify-center rounded-md bg-[#FA8F21] bg-[#FA8F21] hover:bg-[#D87815] gap-2">
                            <x-svg-tambah />
                            <span class="hidden sm:inline">Tambah Peserta Didik</span>
                        </button>
            ...
            <div class="p-4 border-4 border-solid border-[#297785] rounded-lg" id="moving-border">
                <div class="hide-scrollbar max-h-[calc(100%-1rem)] overflow-y-auto">
                                    ...
                                    <div class="relative bg-[#297785] rounded-lg shadow">
                                        ...
                                        <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t">
                                            <h3 class="text-lg font-bold text-white">
                                                Import Excel Peserta Didik SLB
                                            </h3>
                                            <button type="button"
                    ...
                    <div class="relative mt-5 overflow-x-auto overflow-y-auto shadow-sm sm:rounded-lg">
                        <table class="w-full bg-white text-left text-sm text-[#FA8F21] rtl:text-right">
    ...
    <script>
        ...
        async function createExcel(data, namaSekolah) {
            ...
            const titleHeader = [
                [`Daftar Peserta Didik ${sekolahNama}`],
                [`Tanggal Unduh: ${formattedDate}`],
                [`Pengunduh: Admin ${sekolahNama}`],
                []
            ];
            ...
            sheet.getCell('A7').value = `Daftar Peserta Didik ${sekolahNama}`;
            sheet.getCell('A8').value = `Tanggal Unduh: ${formattedDate}`;
            sheet.getCell('A9').value = `Pengunduh: Admin ${sekolahNama}`;
            ...
            saveAs(blob, 'PesertaDidik-SLB.xlsx');
        }
