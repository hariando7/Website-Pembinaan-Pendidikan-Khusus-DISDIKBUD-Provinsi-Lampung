                ...
                <div class="hide-scrollbar max-h-[calc(100%-1rem)] overflow-y-auto">
                    ...
                    <form method="POST" class="font-bold text-black text-sm">
                        ...
                        <div class="grid grid-cols-2 gap-2 mb-2">
                            <div class=''>
                                <label htmlFor="nama">Nama tendik</label>
                                <input type="text" id="nama" name="nama" maxlength="100"
                                    class="border border-[#297785] text-gray-900 text-sm rounded-md focus:ring-[#297785] focus:border-[#297785] h-9 px-2 w-full"
                                    placeholder="Masukkan Nama Tendik (Maksimal 100 Karakter)"
                            ...
                            <div class=''>
                                <div class="flex gap-x-2">
                                    <div class="flex flex-col flex-1 mb-4">
                                        ...
                                        <input type="number" id="nip" name="nip" minlength="8"
                                            class="border border-[#297785] text-gray-900 text-sm rounded-md focus:ring-[#297785] focus:border-[#297785] h-9 px-2 w-full"
                        ...
                        <div class="grid grid-cols-2 gap-2 mb-2">
                            ...
                            <div class=''>
                                <label htmlFor="bidangPekerjaan">Bidang Tugas</label>
                                <input type="text" id="bidangPekerjaan" name="bidangPekerjaan" maxlength="100"
                                    class="border border-[#297785] text-gray-900 text-sm rounded-md focus:ring-[#297785] focus:border-[#297785] h-9 px-2 w-full"
