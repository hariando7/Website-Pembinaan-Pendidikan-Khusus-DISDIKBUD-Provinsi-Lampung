    ...
    <div>
        ...
        <div class="pl-[280px] h-screen pt-2 pr-5 pb-[85px] full-height">
            <div class="flex justify-between pb-2">
                ...
                <div class="">
                    <x-buttitle-landing ref="/admin-tambah-tendik-slb" color="#FA8F21" width="[13rem]"
                        ...
                        <table class="w-full text-sm text-left rtl:text-right text-gray-500 bg-white">
                            ...
                            <tbody>
                                @php
                                    $perPage = 10;
                                    $dummyData = [
                                        ['2022/2023', 'Dummyyyyyyyyyyy 1', 'P', 'Sekolah Dummmmmmmmmmmmmmmmmy 1', '121212121212', 'PNS', 'loremloremlorem lorem'],
                                    ...
                                    <tr
                                        ...
                                        <td class="px-3 py-2">
                                            <div class="flex justify-items-center m-auto text-center gap-2">
                                                <a href="/admin-edit-tendik-slb" title="Edit">
                                                    <div
