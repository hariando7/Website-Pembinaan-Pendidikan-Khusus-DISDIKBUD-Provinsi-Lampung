    ...
    <div>
        ...
        <div class="pl-[280px] h-screen pt-2 pr-5 pb-[85px] full-height">
            <div class="flex justify-between pb-2">
                ...
                <div class="">
                    <x-buttitle-landing ref="/admin-tambah-tendik-slb" color="#FA8F21" width="[13rem]" title="+ Tambah Tendik" extendClass="text-white text-center py-2 lg:py-2 hover:bg-[#D87815]" />
                </div>
            </div>
