...
<body class="bg-white z-10">
    <div>
        ...
        <div class="pl-[280px] h-screen pt-2 pr-5 pb-[85px] full-height">
            <div class="flex pb-2">
                <div class="text-left items-center justify-center text-[#297785] font-bold text-[24px] m-auto w-[40%]">Kebutuhan Guru
                    SLB - {{ $sekolah->nama }}
                </div>
                            ...
                            <div class="mx-auto my-auto flex items-center">
                                <div class="relative w-full">
                                    ...
                                    <input type="text" name="pencarian" id="simple-search"
                                        ...
                                        placeholder="Cari Guru Mapel" oninput="cekKosong(this)"
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            document.getElementById('downloadExcel').addEventListener('click', async function() {
                let data = await fetch('/api/kebutuhan-guru');
                ...
                function createExcel(data) {
                    ...
                    XLSX.utils.book_append_sheet(wb, ws, 'KebutuhanGuru');

                    XLSX.writeFile(wb, 'KebutuhanGuru.xlsx');
                }
