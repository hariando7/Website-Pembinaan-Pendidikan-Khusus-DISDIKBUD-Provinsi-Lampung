...
<body class="bg-white z-10">
                ...
                <div class="flex items-center justify-center rounded gap-2 h-20 border-dashed border-2 border-[#297785] rounded-lg"
                    ...
                    <div>
                        ...
                        <button data-modal-target="select-modal" data-modal-toggle="select-modal"
                            ...
                            type="button">
                            <x-svg-statistik />
                            <span class="hidden sm:inline">Statistik Sarpras</span>
                        </button>
                        <x-admin-statistik-sarpras />
                    </div>
                    <div>
                        {{-- Button Tambah --}}
                        <a href="/admin-sarpras-slb/tambah" type="button"
                            class="btn border-none text-white text-center py-2 lg:py-2 hover:bg-[#D87815 w-[4.5rem] lg:w-[14.5rem] py-1 my-2 flex items-center justify-center rounded-md bg-[#FA8F21] bg-[#FA8F21] hover:bg-[#D87815] gap-2">
                            <x-svg-tambah />
                            <span class="hidden sm:inline">Tambah Sarpras</span>
                        </a>
                    </div>
                </div>
            </div>
                            ...
                            <div class="mx-auto my-auto flex items-center">
                                <div class="relative w-full">
                                    ...
                                    <input type="text" name="pencarian" id="simple-search"
                                        ...
                                        placeholder="Cari Gedung Ruang, Kondisi..." onkeypress="cariDenganEnter(event)"
                                ...
                                <tr
                                    ...
                                    <td class="px-3 py-2">
                                        <div class="flex justify-items-center m-auto text-center gap-2">
                                            <a href="/admin-sarpras-slb/edit/{{ $data['id'] }}" title="Edit">
                                                <div
                                                        ...
                                                        button.addEventListener('click', function() {
                                                            ...
                                                            closeButtonYa.addEventListener('click', () => {
                                                                window.location.href = window.location.origin +
                                                                    '/admin-sarpras-slb/delete/' + button.getAttribute(
                                                                        'data-index');
                                                            });
    ...
    <script>
            ...
            document.getElementById('downloadExcel').addEventListener('click', async function() {
                ...
                try {
                    let response = await fetch(
                        `/api/sarana-prasarana?filterSekolah={{ auth()->user()->sekolah }}&tahun=${tahun}&pencarian=${pencarian}`
                    );
        ...
        async function createExcel(data, namaSekolah) {
            ...
            const titleHeader = [
                [`Daftar Sarpras ${namaSekolah}`], // Judul
            ...
            sheet.getCell('A7').value = `Daftar Sarpras ${namaSekolah}`;
