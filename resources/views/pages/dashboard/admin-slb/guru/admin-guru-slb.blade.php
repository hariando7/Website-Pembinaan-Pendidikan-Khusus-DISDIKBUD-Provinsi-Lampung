    ...
    <div>
        ...
        <div class="pl-[280px] h-screen pt-2 pr-5 pb-[85px] full-height">
            <div class="flex justify-between pb-2">
                ...
                <div class="">
                    <x-buttitle-landing ref="/admin-tambah-guru-slb" color="#FA8F21" width="[13rem]" title="+ Tambah Guru" extendClass="text-white text-center py-2 lg:py-2 hover:bg-[#D87815]" />
                </div>
            </div>
                    ...
                    <div class="relative overflow-x-auto overflow-y-auto shadow-sm sm:rounded-lg mt-5">
                        <table class="w-full text-sm text-left rtl:text-right text-gray-500 bg-white">
                            ...
                            <tbody>
                                ...
                                $perPage = 10;
                                $dummyData = [
                                ['2022/2023', 'Dummyyyyyyyyyyy 1', 'P', '121212121212', 'PNS', 'Sertifikasi', 'loremloremlorem lorem'],
