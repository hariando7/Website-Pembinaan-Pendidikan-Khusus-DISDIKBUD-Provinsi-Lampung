...
<head>
    ...
    <title>Admin SLB | Statistik Tendik | PNS / NON</title>
    ...
    <script>
        async function statistik() {
            ...
            const temp = await fetch(
                `/api/statistik-tenaga-pendidik-pns?tahun=${ encodeURI(filterTahun.value) }&sekolah=${ encodeURI(idSekolah) }`
            );
