...
<head>
    ...
    <title>Admin SLB | Statistik Peserta Didik | Kelas</title>
    ...
    <script>
        async function statistik() {
            ...
            const temp = await fetch(
                `/api/statistik-peserta-didik-kelas?tahun=${ encodeURI(filterTahun.value) }&sekolah=${ encodeURI(idSekolah) }&jenisKetunaan=${ encodeURI(filterDisabilitas.value) }`
            );
