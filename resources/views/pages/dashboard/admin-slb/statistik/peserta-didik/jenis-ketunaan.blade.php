...
<head>
    ...
    <title>Admin SLB | Statistik Peserta Didik | Jenis Ketunaan</title>
        ...
        <div class="p-4 sm:ml-64 min-h-screen">
            <div class="lg:flex lg:justify-between pb-2">
                ...
                <div class="m-auto items-center justify-center text-center text-xl font-bold text-[#297785]">Statistik
                    Peserta Didik By Jenis Ketunaan
                </div>
                <div>
                    {{-- Button Statistik --}}
    ...
    <script>
        async function statistik() {
            ...
            const temp = await fetch(
                `/api/statistik-peserta-didik-jenisKetunaan?tahun=${ encodeURI(filterTahun.value) }&sekolah=${ encodeURI(idSekolah) }&kelas=${ encodeURI(filterKelas.value) }`
            );
