...
<head>
    ...
    <title>Admin SLB | Statistik Guru | Sertifikasi / NON</title>
        ...
        <div class="min-h-screen pb-28 pl-[280px] pr-5 pt-5">
            <div class="flex justify-between pb-2">
                ...
                <div class="m-auto items-center justify-center text-center text-xl font-bold text-[#297785]">Statistik
                    Guru By Sertifikasi / Non Sertifikasi
                </div>
    ...
    <script>
        async function statistik() {
            ...
            const temp = await fetch(
                `/api/statistik-guru-sertifikasi?tahun=${ encodeURI(filterTahun.value) }&sekolah=${ encodeURI(idSekolah) }&statusPNS=${ encodeURI(filterPNS.value) }`
            );
