...
<head>
    ...
    <title>Login | Bidang Pembinaan Pendidikan Khusus | Disdikbud Provinsi Lampung</title>
    ...
    <div class="relative w-full min-h-screen bg-cover bg-no-repeat bg-center"
        ...
        <div class="flex justify-between pl-10 pr-10 pt-10 absolute w-full">
            ...
            <div class="flex items-start">
                <x-buttitle-landing ref="/kelola-admin-slb" color="#FA8F21" width="[10rem]" title="Home"
