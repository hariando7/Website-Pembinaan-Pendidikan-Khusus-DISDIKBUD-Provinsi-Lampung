...
<head>
    ...
    <script>
        // fungtion lain
        function togglePasswordVisibility(inputNumber) {
            ...
            if (inputNumber === 1) {
                ...
                eyeOpenIcon.style.display = (passwordInput.type === "password") ? "block" : "none";
                eyeCloseIcon.style.display = (passwordInput.type === "password") ? "none" : "block";
            } else if (inputNumber === 2) {
                passwordInput2.type = (passwordInput2.type === "password") ? "text" : "password";
                eyeOpenIcon2.style.display = (passwordInput2.type === "password") ? "block" : "none";
                eyeCloseIcon2.style.display = (passwordInput2.type === "password") ? "none" : "block";
            }
        }
    </script>
            ...
            <form action="{{ url('/login') }}" method="POST"
                ...
                <div class="m-auto flex flex-col w-full">
                    <div class="heading mb-2 text-center text-black">
                        <div class="text-[24px] font-bold">Buat Password Baru</div>
                        <div class="mt-2">
                            <div class="text-base">Minimal password 8 kata, harus sama</div>
                        </div>
                    </div>
                            ...
                            <label class="block">
                                ...
                                <div class="password-container">
                                    <input type="password" name="password" id="password"
                                        ...
                                        placeholder="*********"
                                        oninvalid="this.setCustomValidity('Input your password, at least 6 characters');"
                            ...
                            <label class="block">
                                ...
                                <div class="password-container">
                                    <input type="password" name="password" id="password2"
                                        ...
                                        oninvalid="this.setCustomValidity('Input your password, at least 6 characters');"
                                        oninput="this.setCustomValidity('')" minLength="6" maxlength="255" required />
                                    <button type="button" class="eye-icon" id="eye-open2"
                                        onclick="togglePasswordVisibility(2)">
                                        <!-- ... existing eye icon SVG ... -->
                                        <svg id="eye-open2" width="1em" height="1em" viewBox="0 0 16 16"
                                            class="bi bi-eye-fill cursor-pointer text-black" fill="currentColor"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path d="M10.5 8a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0z" />
                                            <path fill-rule="evenodd"
                    ...
                    <button type="submit" id="signIn"
                        class="w-full h-15 text-base text-white bg-[#FA8F21] hover:bg-[#D87815] focus:ring-4 focus:ring-blue-300 px-5 py-2.5 mr-2 mb-2 dark:bg-[#FA8F21] dark:hover:bg-[#D87815] rounded transition duration-300">Simpan</button>
                    <div class="text-center mb-5">
                        <a href="/lupa-password">
                            <div class="text-black text-base text-bold">Back to Sign In</div>
                        </a>
                    </div>
                </div>
            </form>
