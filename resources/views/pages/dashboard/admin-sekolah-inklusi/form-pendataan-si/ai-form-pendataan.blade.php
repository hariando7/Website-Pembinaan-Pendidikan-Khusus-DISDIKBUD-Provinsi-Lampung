...
<head>
    ...
    <title>Form Pendataan Sekolah Inklusi | Bidang Pembinaan Pendidikan Khusus | Disdikbud Provinsi Lampung</title>
    ...
    <div>
        ...
        <div class="pl-[280px] h-full pt-2 pr-5 pb-10">
            <div class="flex justify-between pb-2 mt-5">
                <div class="text-[#297785] font-bold text-[32px]">Pendataan Sekolah Inklusi Provinsi Lampung
                </div>
