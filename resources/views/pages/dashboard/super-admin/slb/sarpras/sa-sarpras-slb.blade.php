...
<body class="bg-white z-10">
        ...
        <div class="pl-[280px] h-screen pt-2 pr-5 pb-[85px] full-height">
            <div class="flex justify-between pb-2">
                ...
                <div class="">
                    ...
                    <button data-modal-target="select-modal5" data-modal-toggle="select-modal5" title="Visualisasi Statistik Sarpras SLB Berdasarkan Sekolah dan Tahun Ajaran"
    ...
    <script>
        ...
        function createExcel(data, namaSekolah) {
            ...
            XLSX.writeFile(wb, 'Sarpras-SLB-ProvinsiLampung.xlsx');
        }
