            ...
            <div class="lg:flex lg:justify-between pb-2 gap-5">
                ...
                <div class="">
                    ...
                    <button data-modal-target="select-modal6" data-modal-toggle="select-modal6"
                        title="Visualisasi Statistik Tendik SLB Berdasarkan Sekolah, PNS, dan Tahun Ajaran"
                            ...
                            <div class="flex items-center mx-auto my-auto">
                                <div class="relative w-full">
                                    ...
                                    <input type="text" name="pencarian" id="simple-search"
                                        ...
                                        placeholder="Cari Nama Sekolah, Nama Tendik, Jenis Kelamin, NIP, PNS/Non, Bidang Tugas Pekerjaan"
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            document.getElementById('downloadExcel').addEventListener('click', async function() {
                ...
                const dataUrl =
                    `/api/tenaga-pendidik?filterSekolah=${filterSekolah}&tahun=${tahun}&pencarian=${pencarian}`;
        ...
        async function createExcel(data, namaSekolah) {
            ...
            const titleHeader = [
                [`Daftar Tendik SLB Provinsi Lampung || ${namaSekolah}`],
            ...
            sheet.getCell('A7').value = `Daftar Tendik SLB Provinsi Lampung || ${namaSekolah}`;
            ...
            saveAs(blob, 'Tenaga-Pendidik-SLB-ProvinsiLampung.xlsx');
        }
