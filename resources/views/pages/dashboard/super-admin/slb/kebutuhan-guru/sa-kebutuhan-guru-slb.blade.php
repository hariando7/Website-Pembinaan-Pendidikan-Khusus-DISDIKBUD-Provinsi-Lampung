...
<body class="bg-white z-10">
        ...
        <div class="pl-[280px] h-screen pt-2 pr-5 pb-[85px] full-height">
            <div class="flex justify-between pb-2">
                ...
                <div class="">
                    ...
                    <button data-modal-target="select-modal4" data-modal-toggle="select-modal4" title="Visualisasi Statistik Kebutuhan Guru SLB Berdasarkan Sekolah dan Tahun Ajaran"
    ...
    <script>
        ...
        function createExcel(data, namaSekolah) {
            ...
            XLSX.writeFile(wb, 'KebutuhanGuru-SLB-ProvinsiLampung.xlsx');
        }
