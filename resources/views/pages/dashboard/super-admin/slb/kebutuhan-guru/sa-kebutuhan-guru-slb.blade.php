...
<head>
    ...
    <title>Data SLB | Kebutuhan Guru</title>
    ...
    <div>
        ...
        <div class="p-4 sm:ml-64 min-h-screen text-sm">
            <div class="lg:flex lg:justify-between pb-2 gap-5">
                <div
                    class="text-center items-center justify-center text-[#297785] font-bold ttext-[20px] lg:text-[28px]">
                    Kebutuhan Guru
                ...
                <div class="">
                    ...
                    <button data-modal-target="select-modal4" data-modal-toggle="select-modal4"
                        title="Visualisasi Statistik Kebutuhan Guru SLB Berdasarkan Sekolah dan Tahun Ajaran"
                            ...
                            <div class="flex items-center mx-auto my-auto">
                                <div class="relative w-full">
                                    ...
                                    <input type="text" name="pencarian" id="simple-search"
                                        ...
                                        placeholder="Cari Nama Sekolah, Guru Mapel..."
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            document.getElementById('downloadExcel').addEventListener('click', async function() {
                ...
                const dataUrl =
                    `/api/kebutuhan-guru?filterSekolah=${filterSekolah}&tahun=${tahun}&pencarian=${pencarian}`;
        ...
        async function createExcel(data, namaSekolah) {
            ...
            const titleHeader = [
                [`Daftar Kebutuhan Guru Tenaga Kerja SLB Provinsi Lampung || ${namaSekolah}`],
            ...
            sheet.getCell('A7').value = `Daftar Kebutuhan Guru Tenaga Kerja SLB Provinsi Lampung || ${namaSekolah}`;
            ...
            saveAs(blob, 'KebutuhanGuru-SLB-ProvinsiLampung.xlsx');
        }
