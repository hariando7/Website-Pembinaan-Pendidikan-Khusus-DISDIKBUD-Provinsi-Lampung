...
<head>
    ...
    <title>Super Admin SLB | Statistik Peserta Didik | Tahun Ajaran</title>
    ...
    <script>
        async function statistik() {
            ...
            const temp = await fetch(
                `/api/statistik-peserta-didik-tahun?kelas=${ encodeURI(filterKelas.value) }&sekolah=${ encodeURI(filterSekolah.value) }&jenisKetunaan=${ encodeURI(filterDisabilitas.value) }`
            );
