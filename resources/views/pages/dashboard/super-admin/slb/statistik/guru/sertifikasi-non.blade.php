...
<head>
    ...
    <title>Super Admin SLB | Statistik Guru | Sertifikasi / NON</title>
...
<body class="z-10 bg-white">
        ...
        <div class="min-h-screen pb-28 pl-[280px] pr-5 pt-5">
            <div class="flex justify-between pb-2">
                ...
                <div class="m-auto items-center justify-center text-center text-xl font-bold text-[#297785]">Statistik
                    Guru SLB By Sertifikasi / Non Sertifikasi Provinsi Lampung
                </div>
                <div class="">
                    <x-sa-statistik-guru />
    ...
    <script>
        async function statistik() {
            ...
            const temp = await fetch(`/api/statistik-guru-sertifikasi?tahun=${ encodeURI(filterTahun.value) }&sekolah=${ encodeURI(filterSekolah.value) }&statusPNS=${ encodeURI(filterPNS.value) }`);
            const dummyData = await temp.json();

            // const dummyData = [{
            //         sertifikasinon: 'Sertifikasi',
            //         total: 100,
            //         perempuan: 50,
            //         lakiLaki: 70
            //     },
            //     {
            //         sertifikasinon: 'Non Sertifikasi',
            //         total: 100,
            //         perempuan: 40,
            //         lakiLaki: 60
            //     },
            ...
            dummyData.forEach(item => {
                labels.push(item['sertifikasinon']);
                ...
                options: {
                    scales: {
                        x: {
                            ...
                            title: {
                                display: true,
                                text: 'Sertifikasi / Non Sertifikasi'
                            }
                        },
                        y: {
                            beginAtZero: true,
