...
<head>
    ...
    <title>Super Admin Statistik Kebutuhan Guru</title>
    ...
    <div>
        ...
        <div class="pl-[280px] h-screen pt-10 pr-5 pb-28">
            <div class="flex justify-between pb-2">
                ...
                <div class="text-center items-center justify-center text-[#297785] font-bold text-[32px]">Statistik Kebutuhan Guru SLB
                </div>
