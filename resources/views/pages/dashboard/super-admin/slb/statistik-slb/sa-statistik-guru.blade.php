...
<head>
    ...
    <title>Data SLB | Statistik Guru</title>
    ...
    <div>
        ...
        <div class="pl-[280px] h-screen pt-10 pr-5 pb-28">
            <div class="flex justify-between pb-2">
                ...
                <div class="text-center items-center justify-center text-[#297785] font-bold text-[32px]">Statistik Guru
                    SLB
                </div>
                            ...
                            <div class="relative p-4 w-full max-w-3xl max-h-full">
                                ...
                                <div class="relative rounded-lg shadow dark:bg-[#297785] bg-[#297785]">
                                    ...
                                    <div class="p-4 md:p-5">
                                        <ol
                                            class="relative border-s border-[#FA8F21] dark:border-[#FA8F21] dark:hover:border-[#D87815] hover:border-[#D87815] ms-3.5 mb-4 md:mb-5">
                                            <li class="mb-10 ms-8">
                                                <span
                                                    class="absolute flex items-center justify-center w-6 h-6 bg-[#297785] rounded-full -start-3.5 ring-8 dark:ring-[#FA8F21] ring-[#FA8F21] dark:hover:ring-[#D87815] hover:ring-[#D87815] dark:bg-[#297785]">
                                                    <svg class="w-2.5 h-2.5 text-gray-400 dark:text-gray-400"
