...
<body class="bg-white z-10">
        ...
        <div class="pl-[280px] min-h-screen pt-5 pr-5 pb-28">
            <div class="flex justify-between pb-2">
                ...
                <div class="text-center items-center justify-center text-[#297785] font-bold text-xl m-auto">Statistik
                    Tendik SLB Provinsi Lampung
                </div>
                <div class="div">
                    <x-buttitle-landing ref="/sa-tendik-slb" color="#FA8F21" width="[13rem]" title="Selengkapnya"
                        extendClass="text-white text-center py-2 lg:py-2 hover:bg-[#D87815]" />
                </div>
            </div>
    ...
    <script>
        async function statistik() {
            ...
            let temp = await fetch('/api/statistik-tenaga-pendidik');
            let tendik = await temp.json();
