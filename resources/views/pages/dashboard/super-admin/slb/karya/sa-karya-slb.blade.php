    ...
    <div>
        ...
        <div class="p-4 sm:ml-64 min-h-screen text-sm">
            <div class="lg:flex lg:justify-between pb-2 gap-5">
                <div class="text-center items-center justify-center text-[#297785] font-bold text-[20px] lg:text-[28px]">Karya SLB
                    Provinsi Lampung
                </div>
                <div class="">
                            ...
                            <div class="flex items-center mx-auto my-auto">
                                <div class="relative w-full">
                                    ...
                                    <input type="text" name="pencarian" id="simple-search"
                                        ...
                                        placeholder="Cari Nama Sekolah, Nama Karya..."
                                        ...
                                        <div class="grid grid-cols-1 gap-5">
                                            <div class="w-full rounded overflow-hidden">
                                                <div id="default-carousel"
                                                    ...
                                                    data-carousel="slide">
                                                    <!-- Carousel wrapper -->
                                                    <div class="relative h-[200px] w-[250px] overflow-hidden">
                                                        <!-- Item 1 -->
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            document.getElementById('downloadExcel').addEventListener('click', async function() {
                ...
                const dataUrl =
                    `/api/karya?filterSekolah=${filterSekolah}&tahun=${tahun}&pencarian=${pencarian}`;
        ...
        async function createExcel(data, namaSekolah) {
            ...
            const titleHeader = [
                [`Daftar Karya SLB Provinsi Lampung || ${namaSekolah}`],
