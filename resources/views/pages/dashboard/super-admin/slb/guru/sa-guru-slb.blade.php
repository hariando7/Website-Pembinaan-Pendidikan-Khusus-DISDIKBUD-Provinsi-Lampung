...
<body class="bg-white z-10">
    <div>
        ...
        <div class="p-4 sm:ml-64 min-h-screen text-sm">
            <div class="lg:flex lg:justify-between pb-2 gap-5">
                <div class="text-center items-center justify-center text-[#297785] font-bold text-[20px] lg:text-[28px]">Guru SLB
                    Provinsi Lampung
                </div>
                <div class="">
                    <x-sa-statistik-guru />
                    <button data-modal-target="select-modal2" data-modal-toggle="select-modal2"
                        title="Visualisasi Statistik Guru SLB Berdasarkan Sekolah, PNS, Sertifikasi dan Tahun Ajaran"
    ...
    <script>
        ...
        async function createExcel(data, namaSekolah) {
            ...
            sheet.getCell('A7').value = `Daftar Guru SLB Provinsi Lampung || ${namaSekolah}`;
            ...
            saveAs(blob, 'Guru-SLB-ProvinsiLampung.xlsx');
        }
