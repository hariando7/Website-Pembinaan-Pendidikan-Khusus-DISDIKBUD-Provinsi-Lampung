    ...
    <div>
        ...
        <div class="pl-[280px] h-screen pt-2 pr-5 pb-[85px] full-height">
            <div class="flex justify-between pb-2">
                <div class="text-center items-center justify-center text-[#297785] font-bold text-[32px]">Lihat Laporan
                    Pendataan Sekolah Inklusi
                </div>
                {{-- <div class="">
                            ...
                            <tr
                                    ...
                                    <td class="px-3 py-2">
                                        <div class="flex justify-items-center m-auto text-center gap-2">
                                            <a href="/sa-detail-laporan-pendataan-si" title="Edit">
