    ...
    <div>
        ...
        <div class="pl-[280px] h-screen pt-2 pr-5 pb-[85px] full-height">
            <div class="flex justify-start gap-5 pb-2">
                <div class="">
                    <x-buttitle-landing ref="/sa-laporan-pendataan-si" color="#FA8F21" width="[9rem]" title="Kembali"
                        extendClass="text-white text-center py-2 lg:py-2 hover:bg-[#D87815]" />
                </div>
                <div class="text-center items-center justify-center text-[#297785] font-bold text-[32px]">Lihat Laporan Pendataan Sekolah Inklusi
                </div>
            </div>
