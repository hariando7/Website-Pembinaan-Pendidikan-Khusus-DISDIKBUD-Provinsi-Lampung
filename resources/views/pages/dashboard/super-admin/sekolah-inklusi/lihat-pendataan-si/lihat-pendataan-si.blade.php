                                ...
                                <tr class="bg-white border-b dark:bg-white dark:border-gray-700 border-gray-700 hover:bg-[#C4DDDE] dark:hover:bg-[#C4DDDE] text-black hover:text-white">
                                    ...
                                    <td class="px-3 py-2">
                                        <div class="flex justify-items-center m-auto text-center gap-2">
                                            <a href="/sa-detail-lihat-pendataan-si" title="Lihat">
                                            ...
                                            <a href="/sa-detail-lihat-pendataan-si" title="Terima">
                                                <div class="bg-[#0ECF0A] dark:bg-[#0ECF0A] hover:bg-[#0E870B] dark:hover:bg-[#0E870B] p-1 rounded-md">
                                                    <svg width="20" height="20" viewBox="0 0 21 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <path d="M19.5381 1L7.30139 12L1.73926 7" fill="#0ECF0A" />
                                                        <path d="M19.5381 1L7.30139 12L1.73926 7" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                                    </svg>
                                                </div>
                                            </a>
                                            <div class="bg-[#FF0000] hover:bg-[#D51717] p-1 rounded-md cursor-pointer" title="Tolak">
