...
<head>
    ...
    <title>Kelola Sistem | Tambah Pengumuman SLB</title>
    ...
    <div>
        ...
        <div class="pl-[280px] h-screen pt-2 pr-5 pb-28">
            <div class="pb-2 mt-5 flex gap-5">
                <x-buttitle-landing ref="/sa-kelola-pengumuman-slb" color="#FA8F21" width="[7rem]" title="Kembali"
                    extendClass="text-white text-center py-2 lg:py-2 hover:bg-[#D87815]" />
                <div class="text-[#297785] font-bold text-[32px]">Tambah Pengumuman SLB
                </div>
            </div>
