...
<head>
    ...
    <title>Kelola Sistem | Kelola Pengumuman Sekolah Inklusi</title>
        ...
        <div class="pl-[280px] h-screen pt-2 pr-5 pb-[85px] full-height">
            <div class="flex justify-between pb-2">
                ...
                <div class="flex justify-end gap-5">
                    <x-buttitle-landing ref="/sa-kelola-pengumuman-si/tambah" color="#FA8F21" width="[13rem]"
                                ...
                                <tr
                                    ...
                                    <td class="px-3 py-2">
                                        <div class="flex justify-items-center m-auto text-center gap-2">
                                            <a href="/sa-kelola-pengumuman-si/edit" title="Edit">
                                                <div
