...
<head>
    ...
    <title>Kelola Sistem | On/Off Sistem</title>
    ...
    <div>
        ...
        <div class="pl-[280px] h-screen pt-2 pr-5 pb-[85px] full-height">
            <div class="flex justify-between pb-2">
                <div class="text-center items-center justify-center text-[#297785] font-bold text-[32px]">On/Off Sistem
                    SLB dan Sekolah Inklusi
                </div>
            </div>
            <x-buttitle-landing ref="/sa-kelola-sistem" color="#FA8F21" width="[8rem]" title="Kembali"
