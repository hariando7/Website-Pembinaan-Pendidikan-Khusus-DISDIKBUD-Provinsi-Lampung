...
<body>
    <x-layout-landing>
            ...
            <div class="hero min-h-screen bg-[#C4DDDE] pb-10 lg:pb-0 pt-10 lg:pt-0">
                <div class="hero-content flex-col lg:flex-row lg:w-full lg:flex p-5 lg:p-20 gap-10">
                    ...
                    <div>
                        ...
                        <p class="py-6 text-black text-justify">Bidang Pembinaan Pendidikan Khusus memiliki tugas
                            melaksanakan
        ...
        <div id="section1">
            <div class="hero min-h-screen bg-[#C4DDDE] pb-10 lg:pb-0 pt-10 lg:pt-0">
                <div class="hero-content flex-col lg:flex-row lg:w-full lg:flex p-5 lg:p-20 lg:gap-10">
                    <div class="lg:flex lg:gap-5">
                        <div class="w-full lg:w-[40%]">
                            <h1 class="text-2xl lg:text-4xl text-center lg:text-left font-bold text-black">
                                Apa itu Disabilitas ?
                            </h1>
                            <div class="image-container relative slideshow-2 lg:mt-5">
                                <img src="assets/landing/apaItuDisabilitas.svg" alt=""
                                    class="rounded-lg w-[400px] h-[400px] image-zoom" />
                            </div>
                        </div>
                        <div class="w-full lg:w-[60%]">
                            <p class="py-2 text-black text-justify">Disabilitas adalah keterbatasan pada tubuh maupun
                                pikiran
                                yang
                                menyebabkan
                                pengidapnya kesulitan atau mengalami keterbatasan dalam melakukan aktivitas atau
                                berinteraksi dengan lingkungan di sekitarnya. Menurut WHO, diperkirakan terdapat 1,3
                                miliar
                                orang atau sekitar 16% dari populasi global yang mengalami disabilitas.
                                Disabilitas adalah kondisi ketika tubuh serta pikiran mengalami kesulitan atau
                                keterbatasan
                                dalam menjalani aktivitas tertentu. Sementara itu, difabel adalah istilah atau
                                sebutan bagi
                    ...
                    <div id="accordion-nested-parent" data-accordion="collapse">
                        ...
                        <div id="accordion-collapse-body-3" class="hidden"
                            ...
                            <div class="p-5 border border-[#C4DDDE]">
                                ...
                                <p class="mb-2 text-black">Penanganan disabilitas bervariasi sesuai dengan jenisnya:</p>                                
                                <ul class="mb-2 text-black">
        ...
        <div id="section5">
            <div class="hero min-h-screen bg-[#C4DDDE]">
                <div
                    class="hero-content flex-col lg:flex-row-reverse lg:w-full lg:flex lg:flex-row-reverse p-5 lg:p-20 pt-10 pb-10 gap-10">
                    <img src="assets/landing/Pendidikan_SLB.svg"
                        class="w-[80%] h-full m-auto items-center lg:w-[50%] lg:h-[40%] lg:mb-0" />
                    <div>
                        <h1 class="text-2xl lg:text-5xl text-center lg:text-left font-bold text-black pb-5 lg:pb-5">
                            Sekolah
                            Luar Biasa</h1>
                        <p class="py-6 text-black">Sekolah Luar Biasa (SLB) adalah lembaga pendidikan yang merupakan
                            bagian
                            integral dari sistem pendidikan nasional dan ditujukan khusus bagi peserta didik yang
                            mengalami kesulitan dalam proses pembelajaran akibat kelainan fisik, emosional, atau mental
                            sosial. SLB berperan sebagai bagian dari lembaga pendidikan yang dapat mengakomodasi dan
                            menyelenggarakan pendidikan khusus untuk anak-anak dengan kebutuhan khusus. Jenis kebutuhan
                            tersebut mencakup berbagai kondisi, seperti tunanetra, tunarungu, tunawicara, tunadaksa,
                            tunalaras, tunaganda, dan anak terbelakangan.</p>
        ...
        {{-- <div id="section3" class="w-full justify-center items-start bg-[#C4DDDE]">
            <div class="lg:w-full lg:flex lg:flex-row-reverse p-5 lg:p-20 pt-10 pb-10">
                <img src="assets/landing/Pendidikan_SLB.svg" alt=""
                    class="w-[40%] h-[40%] m-auto items-center lg:w-[60%] lg:h-[80%] mb-5 lg:mb-0">
                <div class="">
                    <h1 class="text-2xl lg:text-5xl text-center lg:text-left font-bold text-black pb-5 lg:pb-5">Sekolah
                        Luar Biasa</h1>
                    <div class="mx-auto text-black lg:w-full lg:pr-5">
                        <p class="mb-4">Sekolah Luar Biasa (SLB) adalah lembaga pendidikan yang merupakan bagian
                            integral dari sistem pendidikan nasional dan ditujukan khusus bagi peserta didik yang
                            mengalami kesulitan dalam proses pembelajaran akibat kelainan fisik, emosional, atau mental
                            sosial.</p>
                        <p class="mb-4">Meskipun menghadapi tantangan, peserta didik di SLB tetap memiliki potensi
                            kecerdasan dan bakat istimewa.</p>
                        <p>SLB berperan sebagai bagian dari lembaga pendidikan yang dapat mengakomodasi dan
                            menyelenggarakan pendidikan khusus untuk anak-anak dengan kebutuhan khusus. Jenis kebutuhan
                            tersebut mencakup berbagai kondisi, seperti tunanetra, tunarungu, tunawicara, tunadaksa,
                            tunalaras, tunaganda, dan anak terbelakangan.</p>
                    </div>
